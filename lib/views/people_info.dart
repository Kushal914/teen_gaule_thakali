...
class PeopleInfo extends StatefulWidget {
  const PeopleInfo({super.key});

  @override
  State<PeopleInfo> createState() => _PeopleInfoState();
}

class _PeopleInfoState extends State<PeopleInfo> {List<Person> items = [];
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(AppLocalizations.of(context)!.peopleInfo),
